      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="prose max-w-none space-y-6">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-800 mb-4">2. How We Use Information</h2>
              <ul className="list-disc pl-6 text-gray-600 space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-800 mb-4">3. Public Directory Nature</h2>
              <p className="text-gray-600 mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-800 mb-4">5. Google AdSense</h2>
              <p className="text-gray-600 mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-800 mb-4">7. Data Security</h2>
